...
//import ro.mpp.model.CazCaritabil;
//import ro.mpp.model.Donatie;
//import ro.mpp.model.Donator;
...
public class DonatieDBRepository implements IDonatieRepository {
    ...
    protected IDonatorRepository donatorDBRepository;
    protected ICazCaritabilRepository cazCaritabilDBRepository;

    private static final Logger logger= (Logger) LogManager.getLogger();

    public DonatieDBRepository(Properties properties, IDonatorRepository donatorDBRepository, ICazCaritabilRepository cazCaritabilDBRepository) {
